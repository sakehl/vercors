...
case class ColLLVMParser(
  ...
  override def parse[G](
    ...
    val command = Seq(
      ...
      "--passes=module(pallas-declare-variables,pallas-collect-module-spec),function(pallas-declare-function,pallas-assign-pure,llvm-declare-function-contract,pallas-transform-function-body),module(pallas-print-protobuf)",
      readable.fileName,
      "--disable-output",
    )
